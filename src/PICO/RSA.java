...
public class RSA {
	...
	public static void main(String[] args){
		...
		BigInteger encrypt = new BigInteger("",16);
		...
		int base=16;
		byte[] string=encrypt.modPow(new BigInteger(d,base), new BigInteger(n,base)/*new BigInteger(p,base).multiply(new BigInteger(q,base))*/).toByteArray();
