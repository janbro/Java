...
public class NetworkInterfacing {
	 static final String googleApiKey = "AIzaSyBhXcNgl1iWWa68HYzW0-IxROWidJCfYGQ";
	...
	public static String searchBookTitle(String isbn){
	 ...
	 static JSONObject getShopJSON(String barcode) throws IOException{
	 ...
	 static JSONObject getBookJSON(String barcode) throws IOException{
	...
	static Document getKATHTML(String search, String category) throws UnsupportedEncodingException {
