...
public class RSAKeyGenerator {
	...
	public KeyPair generateKeys() {
		BigInteger pubKey = new BigInteger(""+coprime(m.intValue()));
		BigInteger priKey = pubKey.modInverse(m);
		System.out.println("First Prime = " + a + ", Second Prime = " + b + ", c = " + c +
				", m = " + m + ", e = " + pubKey + ", d = " + priKey + ", Public Key = (" + pubKey + 
				", " + c + "), Private Key = (" + priKey + ", " + c + ")");
		return new KeyPair(pubKey, priKey, new BigInteger(""+c));
	}
