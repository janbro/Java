...
public class Cipher {
	...
	public static void main(String[] args) {
		...
		BigInteger e = new BigInteger(nums[0]);
		BigInteger c = new BigInteger(nums[1]);
		...
		nums = input.split(" ");
		BigInteger d = new BigInteger(nums[0]);
		...
		a = new Cipher().decrypt(input, new Key(d, new BigInteger(""+c1)));
		System.out.println(a);
	}
