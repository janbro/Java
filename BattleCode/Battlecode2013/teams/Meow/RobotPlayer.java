...
public class RobotPlayer {
    ...
    while(true){
        try{
            ...
            int hqDist = (int)(Math.sqrt(Math.pow(rc.senseEnemyHQLocation().x-rc.getLocation().x,2)+Math.pow(rc.senseEnemyHQLocation().y-rc.getLocation().y,2)));
            ...
            if(rc.isActive()){
                ...
                */
                ...
                if(rc.senseEncampmentSquare(rc.getLocation())&&!rc.getLocation().isAdjacentTo(rc.senseHQLocation())||(rc.senseEncampmentSquare(rc.getLocation())&&rc.getLocation().isAdjacentTo(rc.senseHQLocation())&&rc.getLocation().x%2==rc.getLocation().y%2)){
                    rc.captureEncampment(RobotType.ARTILLERY);
                }
                 
                /*else if(amountOfSoldiers > amountOfOpp + 1 && hqDist < 25 && !rc.senseEncampmentSquare(rc.getLocation())){
